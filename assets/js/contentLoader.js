...
export const ContentLoader={
  async loadAll({corePath,dlcRoot,enabled,coreVersion}){
    const core=await fetchJSON(corePath);
    ...
    return { meta:{coreId:core.id,coreName:core.name,coreVersion,contentVersion:core.contentVersion,activeDlcs:activeDlcs.map(d=>({id:d.id,name:d.name,version:d.version}))}, modules, tutorials:core.tutorials||{}, dlcs };
  }
};
